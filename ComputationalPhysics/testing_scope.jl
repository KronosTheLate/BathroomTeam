##¤ Test 1 - is the global defined inside function?
blavar = 1
function blafunc(x)
    @show blavar
    blavar = 2
...
blafunc2(x) = 2blavar + x
blafunc2(1)   # does not error!


##¤ Test 2 - Redefining an existing global inside function 
function blafunc3(x)
    @show blavar
    blavar = 2
    @show blavar
...
@show blavar; blafunc4(1)
## Copy of Andi_3.jl before he fixed scoping problems (just after commit 5100bca95caeed2bf15062b16f91e0f581c8d9e3)
